...
class ProdukFormFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btnProsesProduk.setOnClickListener{
            ...
            if (status=="edit"){
                api.putProduk(token.toString(),produk?.id.toString().toInt(),admin_id.toString().toInt(),txtFormNama.text.toString(),txtFormHarga.text.toString().toInt(),txtFormStok.text.toString().toInt()).enqueue(object :
                ...
                api.postProduk(token.toString(),admin_id.toString().toInt(),txtFormNama.text.toString(),txtFormHarga.text.toString().toInt(),txtFormStok.text.toString().toInt()).enqueue(object :
                    Callback<ProdukResponsePost> {
                    override fun onResponse(
                        call: Call<ProdukResponsePost>,
                        response: Response<ProdukResponsePost>
