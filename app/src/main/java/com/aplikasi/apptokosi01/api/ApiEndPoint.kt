...
import com.aplikasi.apptokosi01.response.beli.BeliResponsePost
...
interface ApiEndPoint {
    ...
    fun postItemTransaksi(
        ...
        @Field("qty") qty : Int,
        @Field("harga_saat_transaksi") harga_saat_tansaksi : Int
    ...
    fun postBeli(
        ...
        @Field("admin_id") admin_id :Int,
        @Field("total") total : Int
    ):Call<BeliResponsePost>

    @GET("beli")
    fun getBeli(@Header("Authorization") token: String): Call<BeliResponse>
}